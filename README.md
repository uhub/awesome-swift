...
* [varabeis/SPStorkController](https://github.com/varabeis/SPStorkController) - Now playing controller from Apple Music, Mail & Podcasts Apple's apps.
...
* [varabeis/awesome-ios-ui](https://github.com/varabeis/awesome-ios-ui) - A collaborative list of awesome UI & Animation only in Swift. Include quick preview.
...
* [netyouli/WHC_ConfuseSoftware](https://github.com/netyouli/WHC_ConfuseSoftware) - u3d、cocos2dx、flutter、iOS代码混淆、自动翻新专家(WHC_ConfuseSoftware)是一款新一代运行在MAC OS平台的App、完美支持Objc和Swift、U3D、Flutter、Cocos2dx项目代码的自动翻新(混淆)、支持文件夹名称、文件名、修改资源文件hash值、类名、方法名、属性名、添加混淆函数方法体、添加混淆属性、自动调用生成的混淆方法、字符串混淆加密等。。。功能强大而稳定。
* [varabeis/SPAlert](https://github.com/varabeis/SPAlert) - Native alert from Apple Music & Feedback. Contains Done, Heart & Message and other presets.
...
* [Snapworks/LocationManager](https://github.com/Snapworks/LocationManager) - CLLocationManager wrapper in Swift, performs location update, geocoding and reverse geocoding using Apple and Google service
...
* [heestand-xyz/PixelKit](https://github.com/heestand-xyz/PixelKit) - Live Graphics Framework
...
* [alickbass/CodableFirebase](https://github.com/alickbass/CodableFirebase) - Use Codable with Firebase
...
* [wayfair-archive/brickkit-ios](https://github.com/wayfair-archive/brickkit-ios) - DEPRECATED - BrickKit For IOS
...
* [Zewo/Reflection](https://github.com/Zewo/Reflection) - DEPRECATED
...
* [hexagons/PixelKit](https://github.com/hexagons/PixelKit) - Live Graphics Framework
